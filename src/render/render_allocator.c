...
void rnd_alloc_buffer(RND_Allocator *allocator, RND_Context *rc, VkBufferCreateInfo info,
    ...
    VK_CHECK_FATAL(vkCreateBuffer(rc->logical, &info, NULL, buffer), EXT_VK_BUFFER_CREATE,
    ...
    VK_CHECK_FATAL(vkBindBufferMemory(rc->logical, *buffer, *memory, 0), EXT_VK_MEMORY_BIND,
