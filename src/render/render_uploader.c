...
RND_Uploader rnd_uploader_create(RND_Context *rc) {
  ...
  bi.size = RND_CONTEXT_STAGING_SIZE;
  ...
  VK_CHECK_ERROR(vkMapMemory(uploader.device, uploader.staging_memory, 0, RND_CONTEXT_STAGING_SIZE,
                             0, &uploader.base_mapped),
